...
namespace assignmnet_301.Tools
{
    ...
    {
        void add(Tool aTool, int categoriesIndex, int typesIndex); // add a new tool to the system

        void add(Tool aTool, int quantity); //add new pieces of an existing tool to the system

        void delete(Tool aTool, int categoriesIndex, int typesIndex); //delte a given tool from the system
